...
// Do not hang onto the return value of this if the configs container has been
// modified
...
uint8_t get_id(const config_field &field) { return field[0]; }

bool get_trip(const config_field &field) { return field[1]; }

void set_trip(config_field &field, bool trip) { field[1] = trip ? 1 : 0; }
...
void update_values(
    const std::unordered_map<
        uint8_t, std::tuple<esphome::template_::TemplateSwitch *,
                            esphome::template_::TemplateNumber *>> &map,
